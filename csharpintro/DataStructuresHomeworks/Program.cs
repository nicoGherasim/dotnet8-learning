//[Exercise 1]
// Read the useful resources to get a better understanding of the data structures: https://edu.wantsome.ro/mod/page/view.php?id=18954.

//[Exercise 2]
// Declare a bi-dimensional array that would look like the following
//            123 345 567
//            12  56  -12
//            34  -98 65
//            765 543 321
//Print the two elements in the center of the matrix using position indexes (output: 56, -98).
...
//[Exercise 3]
// Create a list of names. Check if that list has "Ana" (or any other name read from the user) as an element,
...
{
    names.Add(name);
    Console.WriteLine($"The name {name} was not part of the list. It was added.");
}
...
else
{
    ...
    Console.WriteLine("The top of the queue was not a positive number and a multiple of 3 or a multiple of 7. " +
